...
def test_build_falls_back_when_layout_hint_unknown(mock_codegen, mock_plan, mock_revise, mock_text_critique, mock_visual_critique, tmp_path):
...
@patch("src.pipeline.builder.make_plan")
@patch("src.pipeline.builder.generate_slide_code")
def test_build_presentation_end_to_end(mock_codegen, mock_plan, mock_revise, mock_text_critique, mock_visual_critique, tmp_path):
    mock_plan.return_value = {

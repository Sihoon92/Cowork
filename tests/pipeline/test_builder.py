...
@patch("src.pipeline.builder.critique_deck_visual", return_value={"verdict": "SKIP", "issues": []})
@patch("src.pipeline.builder.critique_deck_storyline", return_value={"verdict": "PASS", "issues": []})
@patch("src.pipeline.builder.critique_slide_visual", return_value={"verdict": "SKIP", "issues": []})
...
def test_build_falls_back_when_layout_hint_unknown(mock_codegen, mock_plan, mock_revise, mock_text_critique, mock_visual_critique, mock_deck_storyline, mock_deck_visual, tmp_path):
...
@patch("src.pipeline.builder.make_plan")
@patch("src.pipeline.builder.generate_slide_code")
def test_build_presentation_end_to_end(mock_codegen, mock_plan, mock_revise, mock_text_critique, mock_visual_critique, mock_deck_storyline, mock_deck_visual, tmp_path):
    mock_plan.return_value = {
